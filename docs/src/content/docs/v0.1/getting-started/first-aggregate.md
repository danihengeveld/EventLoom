---
slug: v0.1/getting-started/first-aggregate
...
[Tenancy and ordering](/v0.1/concepts/tenancy-and-ordering).
...
[Production deployment](/v0.1/guides/production-deployment).
...
each retry. See [Append and read events](/v0.1/guides/append-and-read) for expected
