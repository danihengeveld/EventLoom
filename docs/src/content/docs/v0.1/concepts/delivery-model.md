---
slug: v0.1/concepts/delivery-model
...
The [Projections](/v0.1/guides/projections) and [Outbox and application
integration](/v0.1/guides/outbox) guides show the registration, failure recovery,
