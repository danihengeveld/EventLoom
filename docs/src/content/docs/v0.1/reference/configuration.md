---
slug: v0.1/reference/configuration
...
worked examples, use the [configuration guide](/v0.1/guides/configure-ef-core), the
[projections guide](/v0.1/guides/projections), or the
[outbox guide](/v0.1/guides/outbox).
