---
slug: v0.1/guides/append-and-read
...
see [Configure the event store](/v0.1/guides/configure-ef-core).
...
See [Tenancy and ordering](/v0.1/concepts/tenancy-and-ordering) for the full
