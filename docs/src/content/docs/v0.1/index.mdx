...
| --- | --- |
| Evaluate EventLoom from this repository | [Installation](/v0.1/getting-started/installation) |
| Learn the event-sourcing programming model | [Build your first aggregate](/v0.1/getting-started/first-aggregate) |
| Decide where and how to persist events | [Architecture](/v0.1/concepts/architecture) |
| Understand correctness and delivery guarantees | [Tenancy and ordering](/v0.1/concepts/tenancy-and-ordering) and [Delivery model](/v0.1/concepts/delivery-model) |
| Add EventLoom to an application | [Configure the event store](/v0.1/guides/configure-ef-core) |
| Build read models or external integration | [Projections](/v0.1/guides/projections) and [Outbox and application integration](/v0.1/guides/outbox) |
| Run EventLoom in production | [Production deployment](/v0.1/guides/production-deployment) |
...
The [Aggregates and events](/v0.1/concepts/aggregates-and-events) concept explains
why these boundaries matter. The [Ordering API sample](/v0.1/guides/ordering-api)
...
[packages and compatibility reference](/v0.1/reference/packages) and
[configuration reference](/v0.1/reference/configuration) before relying on a
