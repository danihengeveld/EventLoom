...
export default defineConfig({
	integrations: [starlight({
		...
		sidebar: [
			...
			{ label: 'How-to guides', items: [{ label: 'Configure the event store', slug: 'guides/configure-ef-core' }, { label: 'Append and read events', slug: 'guides/append-and-read' }, { label: 'Snapshots', slug: 'guides/snapshots' }, { label: 'Projections', slug: 'guides/projections' }, { label: 'Outbox and application integration', slug: 'guides/outbox' }, { label: 'Production deployment', slug: 'guides/production-deployment' }, { label: 'Ordering API sample', slug: 'guides/ordering-api' }] },
